    ...
    <tbody>
        <tr>
            <td>
                ...
                <p>
                    Этот репозиторий — стартовая мини-курса по Immutable.js, библиотеке с иммутабельными коллекциями данных. В ветке immutable-connected доступна финальная референтная точка. На абордаж! 🚀
                </p>
                <br>
